#include <GL/glut.h>
#include <stdio.h>
 GLfloat xRotated, yRotated, zRotated,xTranslate=0.01;
 int inc=1;
 char f = 'l';
void init(void)
{
...
void DrawCube(void)
{
   ...
   glLoadIdentity();
   glTranslatef(xTranslate,0.0,-10.5);
...
glutMainLoop();
return 0;
}// - See more at: http://www.codemiles.com/c-opengl-examples/draw-3d-cube-using-opengl-t9018.html#sthash.EUtZ7X4E.dpuf
